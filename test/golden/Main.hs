...
dynamic =
  testGroup
    ...
    , golden Dynamic "parenthesized functions" [relfile|test/golden/files/dynamic/ParenthesizedFunctions.purs|]
...
static =
  testGroup
    ...
    , golden Static "parenthesized functions" [relfile|test/golden/files/static/ParenthesizedFunctions.purs|]
